...
You can find a [sample repository on GitHub](https://github.com/holecekp/FuzzyNumbers.Blazor) that demonstrates how to use this library in practice. It is a simple Blazor WebAssembly project that performs arithmetic operations on two fuzzy numbers.
